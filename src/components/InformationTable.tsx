...
const getAreaColorClass = (secretaria: string) => {
  if (secretaria.includes("Agricultura")) {
    return "bg-green-100 text-green-800 border-green-200";
  } else if (secretaria.includes("Infraestruturas")) {
    return "bg-blue-100 text-blue-800 border-blue-200";
  } else if (secretaria.includes("Saúde")) {
    return "bg-red-100 text-red-800 border-red-200";
  } else if (secretaria.includes("Economia")) {
    return "bg-yellow-100 text-yellow-800 border-yellow-200";
  } else if (secretaria.includes("Finanças")) {
    return "bg-purple-100 text-purple-800 border-purple-200";
  } else if (secretaria.includes("Turismo") || secretaria.includes("Cultura")) {
